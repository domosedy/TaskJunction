...
void EchoClient::onConnected() {
    ...
    // sendData(R"({"type":"upload","link":"f@@ghf7POSToKML?"})");
    ...
    sendData(R"({"type": "create", "board-id": 0, "list-id": 0, "card-id": 0, "tag-id": 0, "parent-id": 3, "object-type": "board", "name": "board 3", "description": "this is board 3"})");
