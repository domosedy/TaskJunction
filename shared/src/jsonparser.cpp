...
std::string login_request(const QString &username, const QString &password) {
  json request = {{"type", "login"},
                  {"username", username.toStdString().c_str()},
                  {"password", password.toStdString().c_str()}};
  return request.dump();
}

std::string create_request(const QString &type, const quint32 parent_id,
                           const QString &name, const QString &description,
                           const quint32 board_id, const quint32 list_id,
                           const quint32 card_id, const quint32 tag_id) {
  json request = {{"type", "create"},
                  {"parent-id", parent_id},
                  {"board-id", board_id},
                  {"list-id", list_id},
                  {"card-id", card_id},
...
std::string delete_request(quint32 id, const QString &object_type,
                           quint32 board_id, quint32 list_id, quint32 card_id,
                           quint32 tag_id) {
  json request = {{"type", "delete"},
                  {"id", id},
                  {"board-id", board_id},
                  {"list-id", list_id},
                  {"card-id", card_id},
...
std::string update_request(const QString &object_type, quint32 id,
                           const QString &field, const QString &value,
                           quint32 board_id, quint32 list_id, quint32 card_id) {
  json request = {{"type", "update"},
                  {"id", id},
                  {"board-id", board_id},
                  {"list-id", list_id},
                  {"card-id", card_id},
...
std::string move_request(quint32 to_list_id, int new_pos, quint32 board_id,
                         quint32 list_id, quint32 card_id) {
  json request = {{"type", "move"},
                  {"board-id", board_id},
                  {"list-id", list_id},
                  {"card-id", card_id},
                  {"tag-id", 0},
