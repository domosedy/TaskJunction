...
struct card {
  ...
  card() = default;
  explicit card(quint32 card_id, quint32 list_id, QString name,
                QString description);
...
struct list {
  ...
  list() = default;
  explicit list(quint32 list_id, quint32 board_id, QString name,
                QString description);
...
struct board {
  ...
  board() = default;
  explicit board(quint32 board_id, quint32 user_id, QString name,
                 QString description, QString m_link = "",
...
struct user {
  ...
  void print_data() const { qDebug() << m_user_id << m_name; }
};
